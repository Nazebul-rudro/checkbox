            ...
            <form action="output.php" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-check d-flex">
                    ...
                    <input type="checkbox" name="hobby[]" id="" class="form-check form-check-inline mx-2" value="cricket">
                    <label class="form-check-label " for="cricket">Cricket</label> 
                    <input type="checkbox" name="hobby[]" id="football" class="form-check form-check-inline mx-2" value="football">
                    <label class="form-check-label" for="football" >Football</label> 
                    <input type="checkbox" name="hobby[]" id="hocky" class="form-check form-check-inline mx-2" value="hockys">
                    <label class="form-check-label" for="hocky">Hocky</label> 
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="tel" id="phoneNumber" name="phn" class="form-control form-control-lg" />
